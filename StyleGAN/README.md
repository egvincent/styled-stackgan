note: this is the original readme (below) for StackGAN, but we have modified the directory. 
we might update this later, but for now, we are taking notes on the configuration elsewhere.
